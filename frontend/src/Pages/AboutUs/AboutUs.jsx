...
const testimonials = [
  ...
  },
  {
    ...
    content: `Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et.`
  }
];
      ...
      <Container mt={"10"} maxW="7xl" p={{ base: 5, md: 10 }} mx="auto">
        <Center>
          <VStack spacing={4} px={2} alignItems={{ base: 'center', sm: 'flex-start' }}>
            ...
            <Flex alignItems={'center'} height={{ base: "50rem", md: "20rem" }} flexDirection={{ base: "column", md: "row" }} >
              <Flex height={{ base: "25rem", md: "20rem" }} p={"3"} flexDirection={"column"} alignItems={"center"}>
                <Text textAlign={"justify"} height={{ base: "30rem", md: "10rem", sm: "35rem" }} pl={{ base: "14" }}>
                  Passionate about Tech. Lover of web and opensource. Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores, laborum fugit aliquid error optio, numquam eum nemo illum deserunt maiores vitae cumque repellendus? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ullam aliquid eius, harum, nobis modi quod nulla cupiditate, laboriosam totam consequatur perspiciatis? Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, illum suscipit reprehenderit natus non voluptates placeat quas perspiciatis aperiam?
                </Text>
                <Box>
                  <Button
                    bg="red.500"
            ...
            <VStack spacing={4} w="100%">
              <Stack w="100%" spacing={3} direction={{ base: 'column', md: 'row' }}>
                <FormControl id="name" isRequired>
                  ...
                  <Input type="text" placeholder="Your good name" rounded="md" />
                </FormControl>
                <FormControl id="email" isRequired>
                  <FormLabel>Email</FormLabel>
                  <Input type="email" placeholder="Eg: md@md.com" rounded="md" />
                </FormControl>
              </Stack>
