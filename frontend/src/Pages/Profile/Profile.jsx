...
const ProfilePage = () => {
    ...
    useEffect(() => {
        ...
        if (userEmail) {
            setEmail(userEmail);
            axios.get(`https://readmemaker-backend.vercel.app/users/getNameByEmail/${userEmail}`)
                .then(response => {
    ...
    const handleChangePassword = async () => {
        ...
        if (newPassword === retypePassword) {
            try {
                const response = await fetch('https://readmemaker-backend.vercel.app/users/updatePassword', {
                    method: 'PUT',
                    headers: {
    ...
    return (
        <Box position="relative" width="100%" height="100vh" marginTop="-80px">
            ...
            <VStack spacing={6} mt="20%">
                ...
                >
                    <Heading as="h2" size="md" mb={4}>Change Password</Heading>
