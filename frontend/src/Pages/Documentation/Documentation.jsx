...
import img1 from "../../MediaFiles/readmeBg.png";
import img2 from "../../MediaFiles/page1.png";
  ...
  },
  {
    ...
    subtopics: [
      ...
      },
      {
        ...
        content:
          "Having issues? Don’t worry! Check out our troubleshooting guide on About page and can report bugs. Most problems can be solved by a good ol' restart or clearing your browser cache. If not, we've got FAQs that might help!",
  ...
  },
  {
    ...
    subtopics: [
      ...
      },
      {
        ...
        code: "cd frontend && npm start && cd ../backend && npm start",
      },
      {
