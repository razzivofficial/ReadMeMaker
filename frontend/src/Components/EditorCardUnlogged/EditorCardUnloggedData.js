...
const data = [
  {
    ...
    username: "andyruwruw",
    profilePic:
      "https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExbHRjaTEyeXlrYWgzaWgxNXNxbTJzcTl5Y2g3OGQ4M3ppMzU4MmVycyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/fXsTOgADDa1QA/giphy.webp",
    projectTitle: "GitHub Portfolio",
    upvotes: 15,
    downvotes: 2,
    comments: 5,
    markdown: `
<h4>Does your code still work without a soundtrack?</h4>

<!-- Just your standard README stuff here -->
<p align="center">
  <a href="https://andyruwruw.vercel.app/api/now-playing?open">
    <!-- Watch the music bars groove to the beat and change colors based on how happy, dancey, and energetic the track is! -->
...
<p align="center">
  <!-- Shoutout to the brilliant mind behind showing React components as images in a README.md and the now-playing widget! -->
...
<p align="center">
  <i>Luckily, you don't need to be a grandmaster to code!</i>
</p>

<p></p>

<h1>Vue.js is my jam, but I dabble in other things too :hammer:</h1>
...
<hr>
  ...
  {
    email: "uarjuncvinod@hotmail.com",
...
![GitHub followers](https://img.shields.io/github/followers/arjuncvinod?style=social) ![GitHub User's stars](https://img.shields.io/github/stars/arjuncvinod?style=social) ![Profile Views](https://komarev.com/ghpvc/?username=arjuncvinod)
...
🔭 Currently working on [my portfolio website](https://arjuncvinod.github.io)

🌱 Learning **React.js** 

💬 Ask me about **Node.js, MongoDB, PHP, MySQL**

📫 Reach out to me at: **arjuncvinod7@gmail.com**

✍ My resume is [here](https://drive.google.com/file/d/1ekHjHAyfKdtdQfXo_kETWMtlcA3wSV5g/view?usp=sharing)
...
- 👨‍💻 Currently working on machine learning and data mining projects using Python.
